...
const DeployGitHub = () => {
  ...
  const deployStudio = () => {
    ...
    fetch(
      'https://c2je1jc4ub.execute-api.eu-central-1.amazonaws.com/beta/stackbot/add-webhook/a82160ce-d524-4669-9838-57cf65aa0205/akulk5/liberty-beauty-portal',
      {
        method: 'POST',
        ...
        <ul className={styles.mid_container}>
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/akulk5/liberty-beauty-portal/actions?query=workflow%3A%22Studio+%7C+Build+and+Deploy%22">View Studio Deployment</a>
              </figcaption>
            </figure>
            <button
          ...
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/akulk5/liberty-beauty-portal/actions?query=workflow%3A%22Web+%7C+Build+and+Deploy%22">View Web Deployment</a>
              </figcaption>
            </figure>
            <div>
              <button
